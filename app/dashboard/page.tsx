...
import { Smartphone, TrendingUp, FileText, Activity } from 'lucide-react'
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-6 space-y-8">
          ...
          <div>
            ...
            <p className="text-zinc-400 mt-1">Voici l'état de votre parc applicatif</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[#111111] border border-[#333333] rounded-lg p-5 hover:border-white transition">
          ...
          <div className="bg-[#111111] border border-[#333333] rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-white font-semibold">Timeline des builds</h2>
              <Link href="/apps/new">
                <button className="px-3 py-1 bg-white text-black text-sm font-medium rounded-lg hover:bg-zinc-200 transition">
                  + Nouvelle app
                </button>
              </Link>
            </div>
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between py-3 border-b border-[#222222] last:border-0">
                  <div className="flex items-center gap-3">
                    <div className={`w-2 h-2 rounded-full ${app.status === 'success' ? 'bg-[#00CC88]' : 'bg-[#F5A623]'}`} />
                    <span className="text-white text-sm">{app.name}</span>
                    <span className="text-zinc-500 text-xs">{app.version}</span>
                  </div>
